...
if not os.getenv("AZURE_OPENAI_API_INSTANCE_NAME"):
    logger.warning("AZURE_OPENAI_API_INSTANCE_NAME environment variable is not set.")

if not os.getenv("AZURE_OPENAI_API_DEPLOYMENT_NAME"):
    logger.warning("AZURE_OPENAI_API_DEPLOYMENT_NAME environment variable is not set.")
